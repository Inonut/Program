...
class ImageFormatter extends ImageView {
    ...
    synchronized static licenta.util.image.ImageFormatter of(Image image) {
        new licenta.util.image.ImageFormatter(image: image, smooth: true, cache: true, pixelFormat: PixelFormat.getIntArgbPreInstance())
    }

    synchronized static licenta.util.image.ImageFormatter of(File file) {
    ...
    synchronized licenta.util.image.ImageFormatter scalingImage(double width, double height) {
    ...
    synchronized licenta.util.image.ImageFormatter rotate(int ungle) {
    ...
    synchronized licenta.util.image.ImageFormatter convertToGray() {
    ...
    public synchronized licenta.util.image.ImageFormatter getSemnificativeImage() {
