...
public class Util {
    ...
    public synchronized static Alert confirmMessage(String headerText) {
        ...
        return new Alert(CONFIRMATION).with {
            ...
            it.buttonTypes.addAll licenta.util.BussinesConstants.BUTTON_YES, licenta.util.BussinesConstants.BUTTON_NO
            return it
        }
    }
    ...
    public synchronized static Alert errorMessage(String headerText) {
        ...
        return new Alert(ERROR).with {
            it.headerText = headerText;
            it.buttonTypes.clear();
            it.buttonTypes.addAll licenta.util.BussinesConstants.BUTTON_CANCEL_CLOSE;
            return it
        };
    }
    ...
    public synchronized static FileImage prepareFileImage(Image image, int ungle) {
        ...
        fileImage.with {
            ...
            it.semnificativeScaledImage = imageAction.scalingImage(licenta.util.BussinesConstants.WIDTH, licenta.util.BussinesConstants.HEIGHT).image;
